...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const handleImageDrop = (dropZone) => {
    ...
    if (tabsContainer) {
        ...
        const activateTab = (tabToActivate) => {
            ...
            const tabName = tabToActivate.dataset.tab;
            if (!tabName) return;
            ...
            tabContents.forEach(content => {
                // The ID format in your HTML is tab-content-Registrations, tab-content-Compliance etc.
